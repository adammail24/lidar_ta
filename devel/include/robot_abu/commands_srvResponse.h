// Generated by gencpp from file robot_abu/commands_srvResponse.msg
// DO NOT EDIT!


#ifndef ROBOT_ABU_MESSAGE_COMMANDS_SRVRESPONSE_H
#define ROBOT_ABU_MESSAGE_COMMANDS_SRVRESPONSE_H
...
struct commands_srvResponse_
{
  ...
  typedef boost::shared_ptr< ::robot_abu::commands_srvResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::robot_abu::commands_srvResponse_<ContainerAllocator> const> ConstPtr;

}; // struct commands_srvResponse_

typedef ::robot_abu::commands_srvResponse_<std::allocator<void> > commands_srvResponse;

typedef boost::shared_ptr< ::robot_abu::commands_srvResponse > commands_srvResponsePtr;
typedef boost::shared_ptr< ::robot_abu::commands_srvResponse const> commands_srvResponseConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::robot_abu::commands_srvResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::robot_abu::commands_srvResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::robot_abu::commands_srvResponse_<ContainerAllocator1> & lhs, const ::robot_abu::commands_srvResponse_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::robot_abu::commands_srvResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::robot_abu::commands_srvResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robot_abu::commands_srvResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robot_abu::commands_srvResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robot_abu::commands_srvResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robot_abu::commands_srvResponse_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::robot_abu::commands_srvResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::robot_abu::commands_srvResponse_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x7a06f282c5865fe1ULL;
  static const uint64_t static_value2 = 0x9b3c0085420e8073ULL;
};

template<class ContainerAllocator>
struct DataType< ::robot_abu::commands_srvResponse_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::robot_abu::commands_srvResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "int32 arg0\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::robot_abu::commands_srvResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::robot_abu::commands_srvResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::robot_abu::commands_srvResponse_<ContainerAllocator>& v)
  {
    s << indent << "arg0: ";
...
#endif // ROBOT_ABU_MESSAGE_COMMANDS_SRVRESPONSE_H
