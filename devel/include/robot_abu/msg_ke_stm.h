// Generated by gencpp from file robot_abu/msg_ke_stm.msg
// DO NOT EDIT!


#ifndef ROBOT_ABU_MESSAGE_MSG_KE_STM_H
#define ROBOT_ABU_MESSAGE_MSG_KE_STM_H
...
struct msg_ke_stm_
{
  ...
  typedef boost::shared_ptr< ::robot_abu::msg_ke_stm_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::robot_abu::msg_ke_stm_<ContainerAllocator> const> ConstPtr;

}; // struct msg_ke_stm_

typedef ::robot_abu::msg_ke_stm_<std::allocator<void> > msg_ke_stm;

typedef boost::shared_ptr< ::robot_abu::msg_ke_stm > msg_ke_stmPtr;
typedef boost::shared_ptr< ::robot_abu::msg_ke_stm const> msg_ke_stmConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::robot_abu::msg_ke_stm_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::robot_abu::msg_ke_stm_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::robot_abu::msg_ke_stm_<ContainerAllocator1> & lhs, const ::robot_abu::msg_ke_stm_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::robot_abu::msg_ke_stm_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::robot_abu::msg_ke_stm_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robot_abu::msg_ke_stm_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robot_abu::msg_ke_stm_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robot_abu::msg_ke_stm_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robot_abu::msg_ke_stm_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::robot_abu::msg_ke_stm_<ContainerAllocator> >
{
  ...
  static const char* value(const ::robot_abu::msg_ke_stm_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x1e62da1cb9b3444cULL;
  static const uint64_t static_value2 = 0xba6540c099267b73ULL;
};

template<class ContainerAllocator>
struct DataType< ::robot_abu::msg_ke_stm_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::robot_abu::msg_ke_stm_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::robot_abu::msg_ke_stm_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::robot_abu::msg_ke_stm_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::robot_abu::msg_ke_stm_<ContainerAllocator>& v)
  {
    s << indent << "speed_x: ";
...
#endif // ROBOT_ABU_MESSAGE_MSG_KE_STM_H
