// Generated by gencpp from file robot_abu/mission.msg
// DO NOT EDIT!


#ifndef ROBOT_ABU_MESSAGE_MISSION_H
#define ROBOT_ABU_MESSAGE_MISSION_H
...
struct mission_
{
  ...
  typedef boost::shared_ptr< ::robot_abu::mission_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::robot_abu::mission_<ContainerAllocator> const> ConstPtr;

}; // struct mission_

typedef ::robot_abu::mission_<std::allocator<void> > mission;

typedef boost::shared_ptr< ::robot_abu::mission > missionPtr;
typedef boost::shared_ptr< ::robot_abu::mission const> missionConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::robot_abu::mission_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::robot_abu::mission_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::robot_abu::mission_<ContainerAllocator1> & lhs, const ::robot_abu::mission_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::robot_abu::mission_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::robot_abu::mission_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robot_abu::mission_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robot_abu::mission_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robot_abu::mission_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robot_abu::mission_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::robot_abu::mission_<ContainerAllocator> >
{
  ...
  static const char* value(const ::robot_abu::mission_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x8b255d36a9b5156dULL;
  static const uint64_t static_value2 = 0x79792657084a67cfULL;
};

template<class ContainerAllocator>
struct DataType< ::robot_abu::mission_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::robot_abu::mission_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::robot_abu::mission_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::robot_abu::mission_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::robot_abu::mission_<ContainerAllocator>& v)
  {
    s << indent << "command: ";
...
#endif // ROBOT_ABU_MESSAGE_MISSION_H
