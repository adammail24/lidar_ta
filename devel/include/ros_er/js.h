// Generated by gencpp from file ros_er/js.msg
// DO NOT EDIT!


#ifndef ROS_ER_MESSAGE_JS_H
#define ROS_ER_MESSAGE_JS_H
...
struct js_
{
  ...
  typedef boost::shared_ptr< ::ros_er::js_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ros_er::js_<ContainerAllocator> const> ConstPtr;

}; // struct js_

typedef ::ros_er::js_<std::allocator<void> > js;

typedef boost::shared_ptr< ::ros_er::js > jsPtr;
typedef boost::shared_ptr< ::ros_er::js const> jsConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ros_er::js_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ros_er::js_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::ros_er::js_<ContainerAllocator1> & lhs, const ::ros_er::js_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::ros_er::js_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ros_er::js_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ros_er::js_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ros_er::js_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ros_er::js_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ros_er::js_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ros_er::js_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ros_er::js_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x27307fc51b0d7a91ULL;
  static const uint64_t static_value2 = 0x1c746c6fbd3def00ULL;
};

template<class ContainerAllocator>
struct DataType< ::ros_er::js_<ContainerAllocator> >
{
  static const char* value()
  {
    return "ros_er/js";
...
template<class ContainerAllocator>
struct Definition< ::ros_er::js_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ros_er::js_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ros_er::js_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ros_er::js_<ContainerAllocator>& v)
  {
    s << indent << "button: ";
