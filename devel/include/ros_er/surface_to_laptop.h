// Generated by gencpp from file ros_er/surface_to_laptop.msg
// DO NOT EDIT!


#ifndef ROS_ER_MESSAGE_SURFACE_TO_LAPTOP_H
#define ROS_ER_MESSAGE_SURFACE_TO_LAPTOP_H
...
struct surface_to_laptop_
{
  ...
  typedef boost::shared_ptr< ::ros_er::surface_to_laptop_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ros_er::surface_to_laptop_<ContainerAllocator> const> ConstPtr;

}; // struct surface_to_laptop_

typedef ::ros_er::surface_to_laptop_<std::allocator<void> > surface_to_laptop;

typedef boost::shared_ptr< ::ros_er::surface_to_laptop > surface_to_laptopPtr;
typedef boost::shared_ptr< ::ros_er::surface_to_laptop const> surface_to_laptopConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ros_er::surface_to_laptop_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ros_er::surface_to_laptop_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::ros_er::surface_to_laptop_<ContainerAllocator1> & lhs, const ::ros_er::surface_to_laptop_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::ros_er::surface_to_laptop_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ros_er::surface_to_laptop_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ros_er::surface_to_laptop_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ros_er::surface_to_laptop_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ros_er::surface_to_laptop_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ros_er::surface_to_laptop_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ros_er::surface_to_laptop_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ros_er::surface_to_laptop_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x6b07eb02f2a67188ULL;
  static const uint64_t static_value2 = 0xd7d9858575aca1a0ULL;
};

template<class ContainerAllocator>
struct DataType< ::ros_er::surface_to_laptop_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::ros_er::surface_to_laptop_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ros_er::surface_to_laptop_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ros_er::surface_to_laptop_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ros_er::surface_to_laptop_<ContainerAllocator>& v)
  {
    s << indent << "speed_x: ";
...
#endif // ROS_ER_MESSAGE_SURFACE_TO_LAPTOP_H
