...
(cl:defmethod cl:initialize-instance :after ((m <tuning>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'tuning)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_abu-msg:<tuning> is deprecated: use robot_abu-msg:tuning instead.")))

(cl:ensure-generic-function 'val_int-val :lambda-list '(m))
(cl:defmethod val_int-val ((m <tuning>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_abu-msg:val_int-val is deprecated.  Use robot_abu-msg:val_int instead.")
  (val_int m))

(cl:ensure-generic-function 'val_float-val :lambda-list '(m))
(cl:defmethod val_float-val ((m <tuning>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_abu-msg:val_float-val is deprecated.  Use robot_abu-msg:val_float instead.")
  (val_float m))

(cl:ensure-generic-function 'counter-val :lambda-list '(m))
(cl:defmethod counter-val ((m <tuning>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_abu-msg:counter-val is deprecated.  Use robot_abu-msg:counter instead.")
  (counter m))

(cl:ensure-generic-function 'is_float-val :lambda-list '(m))
(cl:defmethod is_float-val ((m <tuning>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_abu-msg:is_float-val is deprecated.  Use robot_abu-msg:is_float instead.")
  (is_float m))

(cl:ensure-generic-function 'ctr_msg-val :lambda-list '(m))
(cl:defmethod ctr_msg-val ((m <tuning>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_abu-msg:ctr_msg-val is deprecated.  Use robot_abu-msg:ctr_msg instead.")
  (ctr_msg m))
