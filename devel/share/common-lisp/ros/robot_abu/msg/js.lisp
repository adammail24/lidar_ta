...
(cl:defmethod cl:initialize-instance :after ((m <js>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'js)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_abu-msg:<js> is deprecated: use robot_abu-msg:js instead.")))

(cl:ensure-generic-function 'button-val :lambda-list '(m))
(cl:defmethod button-val ((m <js>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_abu-msg:button-val is deprecated.  Use robot_abu-msg:button instead.")
  (button m))

(cl:ensure-generic-function 'left_js_x-val :lambda-list '(m))
(cl:defmethod left_js_x-val ((m <js>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_abu-msg:left_js_x-val is deprecated.  Use robot_abu-msg:left_js_x instead.")
  (left_js_x m))

(cl:ensure-generic-function 'left_js_y-val :lambda-list '(m))
(cl:defmethod left_js_y-val ((m <js>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_abu-msg:left_js_y-val is deprecated.  Use robot_abu-msg:left_js_y instead.")
  (left_js_y m))

(cl:ensure-generic-function 'right_js_x-val :lambda-list '(m))
(cl:defmethod right_js_x-val ((m <js>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_abu-msg:right_js_x-val is deprecated.  Use robot_abu-msg:right_js_x instead.")
  (right_js_x m))

(cl:ensure-generic-function 'right_js_y-val :lambda-list '(m))
(cl:defmethod right_js_y-val ((m <js>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_abu-msg:right_js_y-val is deprecated.  Use robot_abu-msg:right_js_y instead.")
  (right_js_y m))

(cl:ensure-generic-function 'kiri_kanan-val :lambda-list '(m))
(cl:defmethod kiri_kanan-val ((m <js>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_abu-msg:kiri_kanan-val is deprecated.  Use robot_abu-msg:kiri_kanan instead.")
  (kiri_kanan m))

(cl:ensure-generic-function 'atas_bawah-val :lambda-list '(m))
(cl:defmethod atas_bawah-val ((m <js>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_abu-msg:atas_bawah-val is deprecated.  Use robot_abu-msg:atas_bawah instead.")
  (atas_bawah m))

(cl:ensure-generic-function 'l2-val :lambda-list '(m))
(cl:defmethod l2-val ((m <js>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_abu-msg:l2-val is deprecated.  Use robot_abu-msg:l2 instead.")
  (l2 m))

(cl:ensure-generic-function 'r2-val :lambda-list '(m))
(cl:defmethod r2-val ((m <js>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_abu-msg:r2-val is deprecated.  Use robot_abu-msg:r2 instead.")
  (r2 m))

(cl:ensure-generic-function 'event-val :lambda-list '(m))
(cl:defmethod event-val ((m <js>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_abu-msg:event-val is deprecated.  Use robot_abu-msg:event instead.")
  (event m))
