...
(cl:defmethod cl:initialize-instance :after ((m <sensors>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'sensors)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_pcl_tutorial-msg:<sensors> is deprecated: use my_pcl_tutorial-msg:sensors instead.")))

(cl:ensure-generic-function 'global_pos_x-val :lambda-list '(m))
(cl:defmethod global_pos_x-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_pcl_tutorial-msg:global_pos_x-val is deprecated.  Use my_pcl_tutorial-msg:global_pos_x instead.")
  (global_pos_x m))

(cl:ensure-generic-function 'global_pos_y-val :lambda-list '(m))
(cl:defmethod global_pos_y-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_pcl_tutorial-msg:global_pos_y-val is deprecated.  Use my_pcl_tutorial-msg:global_pos_y instead.")
  (global_pos_y m))

(cl:ensure-generic-function 'enc_carry-val :lambda-list '(m))
(cl:defmethod enc_carry-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_pcl_tutorial-msg:enc_carry-val is deprecated.  Use my_pcl_tutorial-msg:enc_carry instead.")
  (enc_carry m))

(cl:ensure-generic-function 'slider-val :lambda-list '(m))
(cl:defmethod slider-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_pcl_tutorial-msg:slider-val is deprecated.  Use my_pcl_tutorial-msg:slider instead.")
  (slider m))

(cl:ensure-generic-function 'rot-val :lambda-list '(m))
(cl:defmethod rot-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_pcl_tutorial-msg:rot-val is deprecated.  Use my_pcl_tutorial-msg:rot instead.")
  (rot m))

(cl:ensure-generic-function 'rot_deg-val :lambda-list '(m))
(cl:defmethod rot_deg-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_pcl_tutorial-msg:rot_deg-val is deprecated.  Use my_pcl_tutorial-msg:rot_deg instead.")
  (rot_deg m))

(cl:ensure-generic-function 'engsel-val :lambda-list '(m))
(cl:defmethod engsel-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_pcl_tutorial-msg:engsel-val is deprecated.  Use my_pcl_tutorial-msg:engsel instead.")
  (engsel m))

(cl:ensure-generic-function 'gyro-val :lambda-list '(m))
(cl:defmethod gyro-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_pcl_tutorial-msg:gyro-val is deprecated.  Use my_pcl_tutorial-msg:gyro instead.")
  (gyro m))

(cl:ensure-generic-function 'gyro_full-val :lambda-list '(m))
(cl:defmethod gyro_full-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_pcl_tutorial-msg:gyro_full-val is deprecated.  Use my_pcl_tutorial-msg:gyro_full instead.")
  (gyro_full m))

(cl:ensure-generic-function 'capit-val :lambda-list '(m))
(cl:defmethod capit-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_pcl_tutorial-msg:capit-val is deprecated.  Use my_pcl_tutorial-msg:capit instead.")
  (capit m))

(cl:ensure-generic-function 'sick_kiri-val :lambda-list '(m))
(cl:defmethod sick_kiri-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_pcl_tutorial-msg:sick_kiri-val is deprecated.  Use my_pcl_tutorial-msg:sick_kiri instead.")
  (sick_kiri m))

(cl:ensure-generic-function 'sick_depan-val :lambda-list '(m))
(cl:defmethod sick_depan-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_pcl_tutorial-msg:sick_depan-val is deprecated.  Use my_pcl_tutorial-msg:sick_depan instead.")
  (sick_depan m))

(cl:ensure-generic-function 'sick_belakang-val :lambda-list '(m))
(cl:defmethod sick_belakang-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_pcl_tutorial-msg:sick_belakang-val is deprecated.  Use my_pcl_tutorial-msg:sick_belakang instead.")
  (sick_belakang m))

(cl:ensure-generic-function 'reset-val :lambda-list '(m))
(cl:defmethod reset-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_pcl_tutorial-msg:reset-val is deprecated.  Use my_pcl_tutorial-msg:reset instead.")
  (reset m))

(cl:ensure-generic-function 'stm_reseted-val :lambda-list '(m))
(cl:defmethod stm_reseted-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_pcl_tutorial-msg:stm_reseted-val is deprecated.  Use my_pcl_tutorial-msg:stm_reseted instead.")
  (stm_reseted m))

(cl:ensure-generic-function 'tilt_kiri-val :lambda-list '(m))
(cl:defmethod tilt_kiri-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_pcl_tutorial-msg:tilt_kiri-val is deprecated.  Use my_pcl_tutorial-msg:tilt_kiri instead.")
  (tilt_kiri m))

(cl:ensure-generic-function 'tilt_kanan-val :lambda-list '(m))
(cl:defmethod tilt_kanan-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_pcl_tutorial-msg:tilt_kanan-val is deprecated.  Use my_pcl_tutorial-msg:tilt_kanan instead.")
  (tilt_kanan m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <sensors>) ostream)
  "Serializes a message object of type '<sensors>"
  (cl:let* ((signed (cl:slot-value msg 'global_pos_x)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
    )
  (cl:let* ((signed (cl:slot-value msg 'global_pos_y)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
    )
  (cl:let* ((signed (cl:slot-value msg 'enc_carry)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 65536) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    )
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <sensors>) istream)
  "Deserializes a message object of type '<sensors>"
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:slot-value msg 'global_pos_x) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'global_pos_y) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'enc_carry) (cl:if (cl:< unsigned 32768) unsigned (cl:- unsigned 65536))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<sensors>)))
  ...
  (cl:format cl:nil "int32 global_pos_x~%int32 global_pos_y ~%# uint8 global_pos_x~%# uint8 global_pos_y~%int16 enc_carry~%int16 slider~%int32 rot~%float32 rot_deg~%int32 engsel~%float32 gyro~%float32 gyro_full~%int16 capit~%float32 sick_kiri~%float32 sick_depan~%float32 sick_belakang~%~%uint8 reset~%uint8 stm_reseted~%~%int8 tilt_kiri~%int8 tilt_kanan~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'sensors)))
  "Returns full string definition for message of type 'sensors"
  (cl:format cl:nil "int32 global_pos_x~%int32 global_pos_y ~%# uint8 global_pos_x~%# uint8 global_pos_y~%int16 enc_carry~%int16 slider~%int32 rot~%float32 rot_deg~%int32 engsel~%float32 gyro~%float32 gyro_full~%int16 capit~%float32 sick_kiri~%float32 sick_depan~%float32 sick_belakang~%~%uint8 reset~%uint8 stm_reseted~%~%int8 tilt_kiri~%int8 tilt_kanan~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <sensors>))
  ...
  (cl:list 'sensors
    ...
    (cl:cons ':enc_carry (enc_carry msg))
