...
(cl:defmethod cl:initialize-instance :after ((m <sensors>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'sensors)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_er-msg:<sensors> is deprecated: use ros_er-msg:sensors instead.")))

(cl:ensure-generic-function 'global_pos_x-val :lambda-list '(m))
(cl:defmethod global_pos_x-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_er-msg:global_pos_x-val is deprecated.  Use ros_er-msg:global_pos_x instead.")
  (global_pos_x m))

(cl:ensure-generic-function 'global_pos_y-val :lambda-list '(m))
(cl:defmethod global_pos_y-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_er-msg:global_pos_y-val is deprecated.  Use ros_er-msg:global_pos_y instead.")
  (global_pos_y m))

(cl:ensure-generic-function 'enc_carry-val :lambda-list '(m))
(cl:defmethod enc_carry-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_er-msg:enc_carry-val is deprecated.  Use ros_er-msg:enc_carry instead.")
  (enc_carry m))

(cl:ensure-generic-function 'slider-val :lambda-list '(m))
(cl:defmethod slider-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_er-msg:slider-val is deprecated.  Use ros_er-msg:slider instead.")
  (slider m))

(cl:ensure-generic-function 'rot-val :lambda-list '(m))
(cl:defmethod rot-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_er-msg:rot-val is deprecated.  Use ros_er-msg:rot instead.")
  (rot m))

(cl:ensure-generic-function 'rot_deg-val :lambda-list '(m))
(cl:defmethod rot_deg-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_er-msg:rot_deg-val is deprecated.  Use ros_er-msg:rot_deg instead.")
  (rot_deg m))

(cl:ensure-generic-function 'engsel-val :lambda-list '(m))
(cl:defmethod engsel-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_er-msg:engsel-val is deprecated.  Use ros_er-msg:engsel instead.")
  (engsel m))

(cl:ensure-generic-function 'gyro-val :lambda-list '(m))
(cl:defmethod gyro-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_er-msg:gyro-val is deprecated.  Use ros_er-msg:gyro instead.")
  (gyro m))
...
(cl:defmethod capit-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_er-msg:capit-val is deprecated.  Use ros_er-msg:capit instead.")
  (capit m))

(cl:ensure-generic-function 'sick_kiri-val :lambda-list '(m))
(cl:defmethod sick_kiri-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_er-msg:sick_kiri-val is deprecated.  Use ros_er-msg:sick_kiri instead.")
  (sick_kiri m))

(cl:ensure-generic-function 'sick_depan-val :lambda-list '(m))
(cl:defmethod sick_depan-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_er-msg:sick_depan-val is deprecated.  Use ros_er-msg:sick_depan instead.")
  (sick_depan m))

(cl:ensure-generic-function 'sick_belakang-val :lambda-list '(m))
(cl:defmethod sick_belakang-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_er-msg:sick_belakang-val is deprecated.  Use ros_er-msg:sick_belakang instead.")
  (sick_belakang m))

(cl:ensure-generic-function 'reset-val :lambda-list '(m))
(cl:defmethod reset-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_er-msg:reset-val is deprecated.  Use ros_er-msg:reset instead.")
  (reset m))

(cl:ensure-generic-function 'stm_reseted-val :lambda-list '(m))
(cl:defmethod stm_reseted-val ((m <sensors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_er-msg:stm_reseted-val is deprecated.  Use ros_er-msg:stm_reseted instead.")
  (stm_reseted m))
