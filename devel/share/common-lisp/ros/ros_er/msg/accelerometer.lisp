...
(cl:defmethod cl:initialize-instance :after ((m <accelerometer>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'accelerometer)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_er-msg:<accelerometer> is deprecated: use ros_er-msg:accelerometer instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <accelerometer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_er-msg:x-val is deprecated.  Use ros_er-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <accelerometer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_er-msg:y-val is deprecated.  Use ros_er-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <accelerometer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_er-msg:z-val is deprecated.  Use ros_er-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'abs-val :lambda-list '(m))
(cl:defmethod abs-val ((m <accelerometer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_er-msg:abs-val is deprecated.  Use ros_er-msg:abs instead.")
  (abs m))

(cl:ensure-generic-function 'deg-val :lambda-list '(m))
(cl:defmethod deg-val ((m <accelerometer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_er-msg:deg-val is deprecated.  Use ros_er-msg:deg instead.")
  (deg m))
