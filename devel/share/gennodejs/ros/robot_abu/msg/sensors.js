...
class sensors {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float32(obj.global_pos_x, buffer, bufferOffset);
    // Serialize message field [global_pos_y]
    bufferOffset = _serializer.float32(obj.global_pos_y, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.global_pos_x = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [global_pos_y]
    data.global_pos_y = _deserializer.float32(buffer, bufferOffset);
