...
set(MSG_I_FLAGS "-Imy_pcl_tutorial:/home/adam/ITSRobocon/lidar_ta/src/my_pcl_tutorial/msg;-Isensor_msgs:/opt/ros/noetic/share/sensor_msgs/cmake/../msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/noetic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/adam/ITSRobocon/lidar_ta/src/my_pcl_tutorial/msg/sensors.msg" NAME_WE)
add_custom_target(_my_pcl_tutorial_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "my_pcl_tutorial" "/home/adam/ITSRobocon/lidar_ta/src/my_pcl_tutorial/msg/sensors.msg" ""
)
...
_generate_msg_cpp(my_pcl_tutorial
  "/home/adam/ITSRobocon/lidar_ta/src/my_pcl_tutorial/msg/sensors.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/my_pcl_tutorial)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/my_pcl_tutorial\")")
  # install generated code
  install(
